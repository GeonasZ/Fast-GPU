...
const DEFAULT_IMAGES = [
  ...
  {
    id: 'pytorch-cuda13-fallback-128',
    label: 'PyTorch 2.11 · CUDA 13.2（兼容回退 CUDA 12.8）',
    baseImage: 'nvcr.io/nvidia/pytorch:26.03-py3',
    repositoryTag: 'pytorch-2.11-cuda13.2-ngc26.03',
    cudaMajor: 13,
    allowCuda128Fallback: true,
  },
  {
  ...
  {
    id: 'pytorch-2.6-cuda12.8',
    label: 'PyTorch 2.6 · CUDA 12.8（NGC 25.01）',
    baseImage: 'nvcr.io/nvidia/pytorch:25.01-py3',
    cudaMajor: 12,
  },
  {
    id: 'pytorch-2.5-cuda12.6',
    label: 'PyTorch 2.5 · CUDA 12.6（NGC 24.10）',
...
module.exports = {runtimeImages, resolveRuntimeImage};
